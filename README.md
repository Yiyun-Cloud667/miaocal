...
解析引擎有 50 条口语基准测试（`npm run test:parser`，当前 50/50 全过），覆盖：

| 输入 | 结果 |
| --- | --- |
| 明天下午3点到5点开项目评审会 | 明天 15:00–17:00 · 工作（蓝） |
| 明天下午三点半和张总开会 | 中文数字时刻 → 明天 15:30 |
| 9月10号到9月15号出差去深圳 | 6 天跨天条 · 出行（橙） |
| 从明天开始出差三天 / 连续加班五天 | 持续天数 → 自动跨 3/5 天 |
| 半小时后提醒我喝水 / 两小时后回访客户 | 相对时间 → 今天对应时刻 |
| 下周三上午体检 / 下下周一答辩 | 星期与下下周 |
| 15号发工资 / 每月15号还花呗 | 裸日号 / 月度重复 |
| 每周五下午3点站会 | 🔁 每周五 15:00 |
| 每个工作日早上9点站会 | 🔁 工作日（周一至周五） |
| 每天早上7点跑步 / 每隔一天健身 | 🔁 每天 / 隔天 |
| 今晚八点半给妈妈打电话 | 今天 20:30 · 生活 |
| 后天中午十二点半和客户吃饭 | 后天 12:30 |
| 今天晚上十点前把报告写完 | 截止语义 → 今天 22:00 |

规则：重复日程若当天时刻已过，自动从下一次发生日开始。
